...
const QUICK_QUESTIONS = {
  VISITOR: [
    {
      label: '刚到公会的话，可以先问我：Git Guild 是什么？',
      message: 'Git Guild 是什么？',
    },
    {
      label: '想试试接委托？点这里问我：冒险家如何接取委托？',
      message: '冒险家如何接取委托？',
    },
    {
      label: '如果你是委托人，可以问我：委托人如何发布委托？',
      message: '委托人如何发布委托？',
    },
    {
      label: '准备演示的话，我可以告诉你：有哪些演示账号？',
      message: '有哪些演示账号？',
    },
  ],
  ADVENTURER: [
    {
      label: '不确定下一步？可以问我：我的委托下一步该做什么？',
      message: '我的委托下一步该做什么？',
    },
    {
      label: '完成修改以后，我能带你确认：如何提交成果？',
      message: '如何提交成果？',
    },
    {
      label: '想看进度的话，可以问我：如何查看我的 PR？',
      message: '如何查看我的 PR？',
    },
    {
      label: '如果被退回，直接问我：我被退回后怎么修改？',
      message: '我被退回后怎么修改？',
    },
  ],
  MAINTAINER: [
    {
      label: '想先处理待办？可以问我：哪些提交需要我审核？',
      message: '哪些提交需要我审核？',
    },
    {
      label: '准备发新任务？我可以说明：如何发布新委托？',
      message: '如何发布新委托？',
    },
    {
      label: '审核通过以后，可以问我：如何合并 PR？',
      message: '如何合并 PR？',
    },
    {
      label: '想看发布进展？点这里问：我发布了哪些委托？',
      message: '我发布了哪些委托？',
    },
  ],
}
