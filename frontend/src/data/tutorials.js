    ...
    steps: [
      {
        ...
        title: '选择时间范围',
        body: '选择“本周”“本月”或“全部”，查看对应时间范围内的成员排名。点击任一范围会自动继续，也可以直接进入下一步。',
        advanceOn: 'event',
      },
      {
        ...
        title: '刷新当前榜单',
        body: '点击“刷新榜单”可重新获取当前时间范围的最新排名、等级和任务数据，也可以直接进入下一步。',
        advanceOn: 'event',
      },
      {
        ...
        title: '滚动查看更多成员',
        body: '前三名会固定展示。将鼠标移入第四名之后的榜单区域并滚动滚轮，可以继续查看直到第五十名；也可以直接完成教程。',
        advanceOn: 'scroll',
      },
    ],
  },
