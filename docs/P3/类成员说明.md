...
| `QuestFilterCriteria` | `keyword`                      | 搜索关键词，用于模糊匹配                            |
| `QuestFilterCriteria` | `sortBy`                       | 列表排序规则                                  |
| `QuestFilterCriteria` | `sortOrder`                    | 排序方向                                    |
| `QuestFilterCriteria` | `page`                         | 页码                                      |
| `QuestFilterCriteria` | `size`                         | 每页数量                                    |
...
| `QuestAssignment`     | `status`                       | 接取状态，如 `ACTIVE`、`ABANDONED`、`COMPLETED` |
